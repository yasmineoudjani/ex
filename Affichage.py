...
class Affichage:
    ...
    def chargement(self, niveau, robot):
        ...
        self.fenetre.blit(self.robot.direction, (self.robot.x, self.robot.y))
        pygame.display.flip()
    ...
    def refresh(self, robot):
        ...
        self.fenetre.blit(self.robot.direction, (self.robot.x, self.robot.y)) #self.robot.direction = l'image dans la bonne direction
        pygame.display.flip()
